class AlumnisController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @alumni.save
        format.html { redirect_to alumnis_path, notice: 'Alumni was successfully created.' }
  ...
  private
    ...
    def alumni_params
      params.require(:alumni).permit(:first_name, :last_name, :email, :grad_year, :phone, :degree)
    end
end
